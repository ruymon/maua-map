...
export function BannerBlurBackdrop({ banner }: BannerBlurBackdropProps) {
  ...
  return (
    <Image
      fill
      src={banner.url}
      className="pointer-events-none absolute inset-0 top-0 max-h-60 scale-y-[-1] opacity-0 blur-[300px] saturate-150 transition-opacity duration-1000 ease-in-out"
      loading="lazy"
      fetchPriority="low"
